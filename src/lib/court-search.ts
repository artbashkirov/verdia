...
// ВАЖНО: Более специфичные категории должны идти ПЕРВЫМИ, чтобы они проверялись раньше общих
const LEGAL_CATEGORIES: Record<string, { keywords: string[]; searchTerms: string; mosGorsudCategory?: string }> = {
  // Специфичные категории (проверяются первыми)
  eviction: {
    keywords: ['выселен', 'выселить', 'квартирант', 'арендатор', 'съемщик', 'нанимател', 'освободить жилье', 'освобождение жилья'],
    searchTerms: 'выселение из жилого помещения',
    mosGorsudCategory: 'Жилищные споры',
  },
  rent: {
    keywords: ['аренд', 'найм жилья', 'договор найма', 'арендная плата', 'не платят за аренду', 'задолженность по аренде'],
    searchTerms: 'взыскание задолженности по договору найма',
    mosGorsudCategory: 'Жилищные споры',
  },
  flood: {
    keywords: ['залив', 'затопил', 'протечк', 'залили соседи'],
    searchTerms: 'залив квартиры возмещение ущерба',
    mosGorsudCategory: 'Жилищные споры',
  },
  childCustody: {
    keywords: ['видеться с ребенком', 'видеться с ребёнком', 'общение с ребенком', 'общение с ребёнком', 'порядок общения', 'не даёт видеться', 'не дает видеться', 'место жительства ребенка', 'место жительства ребёнка', 'определение места жительства'],
    searchTerms: 'порядок общения с ребенком',
  ...
  inheritanceDeadline: {
    keywords: ['пропустил срок наследства', 'пропущен срок наследства', 'восстановить срок наследства', 'срок принятия наследства'],
    searchTerms: 'восстановление срока принятия наследства',
    mosGorsudCategory: 'Наследственные споры',
  },
  inheritanceWill: {
    keywords: ['оспорить завещание', 'недействительность завещания', 'признать завещание'],
    searchTerms: 'оспаривание завещания недействительность',
    mosGorsudCategory: 'Наследственные споры',
  },
  inheritanceUnworthy: {
    keywords: ['недостойный наследник', 'лишить наследства', 'признать недостойным'],
    searchTerms: 'признание наследника недостойным',
    mosGorsudCategory: 'Наследственные споры',
  },
  inheritanceShare: {
    keywords: ['обязательная доля', 'доля в наследстве'],
    searchTerms: 'обязательная доля в наследстве',
    mosGorsudCategory: 'Наследственные споры',
  },
  inheritanceHiding: {
    keywords: ['скрывают имущество', 'скрывают наследство', 'другие наследники скрывают'],
    searchTerms: 'раздел наследственного имущества',
    mosGorsudCategory: 'Наследственные споры',
  },
  inheritance: {
    keywords: ['наследств', 'завещан', 'наследник', 'наследодатель'],
    searchTerms: 'наследственный спор принятие наследства',
    mosGorsudCategory: 'Наследственные споры',
  },
  family: {
    keywords: ['развод', 'брак', 'раздел имущества', 'супруг', 'бывший муж', 'бывшая жена'],
    searchTerms: 'расторжение брака',
    mosGorsudCategory: 'Семейные споры',
  },
  bankruptcy: {
  ...
  // Общие категории (проверяются последними)
  debt: {
  ...
  housing: {
    keywords: ['жилье', 'квартир', 'недвижим', 'управляющ', 'жкх', 'коммунал'],
    searchTerms: 'жилищный спор',
    mosGorsudCategory: 'Жилищные споры',
  },
  consumer: {
