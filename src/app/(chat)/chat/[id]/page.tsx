...
export default function ChatResultPage() {
  ...
  return (
    <div className="flex h-screen bg-background max-w-[100vw] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 max-w-[100vw] overflow-x-hidden p-0 md:p-2 md:pl-0 md:pb-2 pt-[56px] md:pt-2 bg-[#17181A]">
        {/* Scrollable content */}
        <div className="flex-1 min-w-0 overflow-y-auto overflow-x-hidden bg-background md:rounded-2xl pt-6 md:pt-14 px-0">
