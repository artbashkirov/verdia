    ...
    >
      ...
      >
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {/* Dropdown menu */}
          {showDropdown && (
            <div className={`absolute ${isCollapsed ? 'bottom-full mb-2 left-0 right-auto w-[200px]' : 'bottom-full mb-2 left-0 right-0'} bg-white rounded-xl overflow-hidden shadow-lg border border-gray-200 z-50`}>
              <Link
                href="/profile"
